...
async function main() {
  ...
  const prestadoresDeTeste = [
    ...
    },
    {
      ...
      servicos: ['Manutenção de Ar Condicionado', 'Instalação de Ar Condicionado', 'Limpeza de Split'],
    ...
    },
    {
      ...
      servicos: ['Marido de Aluguel', 'Instalação de Suporte de TV', 'Troca de Chuveiro', 'Pequenos Reparos'],
      bairro: 'Jaguaribe'
    }
  ];
